"""
Django settings for codered_site project.
...
INSTALLED_APPS = [
    # This project
    'apptheme_codered', # replaces "website" created by coderedcms start script
    'django_feedparser',
...
ROOT_URLCONF = 'codered_site.urls'
...
WSGI_APPLICATION = 'codered_site.wsgi.application'
...
WAGTAIL_SITE_NAME = 'CODERED_SITE'
...
FEED_RENDER_ENGINES = {
    #'safe-xml': 'apptheme_mezzanine.renderer.SafeRenderer',
